        ...
        <div class="flex items-start justify-between mt-10">
          ...
          <div class="bg-white w-[540px] font-medium">
            ...
            <div class="flex justify-between px-5 py-3 border-b-1 border-b">
              ...
              <h3 class="uppercase">Free</h3>
            </div>
            <div class="px-5 py-3">
              <label for="discount" class="relative before:absolute before:content-['+'] before:top-2 before:left-3 before:cursor-pointer w-full">
                <input type="text" name="discount" class="bg-gray-300 w-full outline-0 placeholder:text-gray-950 py-2 px-5" placeholder="ADD DISCOUNT CODE">
              </label>
            </div>
