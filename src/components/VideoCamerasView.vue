<template>
  <div>
    ...
    <div class="grid grid-cols-3 max-sm:grid-cols-1 max-sm:[&>*:nth-child(7)]:col-span-1 text-white [&>*:nth-child(7)]:col-span-2 [&>*:nth-child(7)]:pointer-events-none bg-neutral-700">
